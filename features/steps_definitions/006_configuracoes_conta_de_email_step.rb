...
Quando("clico para Excluir a conta de Nome {string} e clico para confirmar a exclusao") do |nome_conta|
    @contas_de_email.excluir_conta_email(nome_conta)
    @contas_de_email.confirmar_exclusao
end

Entao("eu realizo a exclusao da Conta de Email com sucesso") do
