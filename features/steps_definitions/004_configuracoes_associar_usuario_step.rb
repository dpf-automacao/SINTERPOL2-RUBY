...
Quando("clico para desvincunlar o Usuario da Unidade e das Areas Associadas") do
    @associar_usuario.desassociar_usuario_unidade_e_area
end

Entao("eu realizo uma Deassociacao de Unidade e Area para o Usuario com sucesso") do
